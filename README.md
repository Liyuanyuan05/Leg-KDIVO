...
R-KDIVO is a robust kinematic-dynamic-inertial-visual odometry framework for legged robot pose estimation. The datasets and source code will be released in the future.
## Platform: AlienGo
